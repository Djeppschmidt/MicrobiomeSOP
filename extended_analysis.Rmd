...
# build data table combining effect size and p-values from DESeq2 and Quantitative differential abundance analysis

# plot effect ratio as a colored butterfly plot. blue is positive effect, red is negative effect, grey is non-significant. Vertical orientation, left side is DESeq2; right side is Quantitative dataset
